...
for i = 1:length(JsonQuery) % keep only deploymnts info from RV CTD. id 172 and 448 and 640 belong to SCB-SBE9001 and SCB-SBE9002 and UTM-SBE9001
    if JsonQuery{i}.platform.jsonInstrumentList.id == 172 || JsonQuery{i}.platform.jsonInstrumentList.id == 448 || JsonQuery{i}.platform.jsonInstrumentList.id == 640 || JsonQuery{i}.platform.jsonInstrumentList.id == 642
